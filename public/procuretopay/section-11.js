...
function loadNextQuestion(){
	...
	if(currentIndex == totQuestions){
		...
		resultCont.textContent = 'Purchase Section assessment completed | Click Submit to proceed to the Next Section.';
		return; 
	}
...
function submitAnswers(){
    ...
    $.ajax({
    	type: "POST",
    	url: "/assessment/procuretopay/purchasesection",
